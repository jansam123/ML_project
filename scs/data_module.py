...
class DataModule(L.LightningDataModule):
    ...
    def __init__(self, config: dict):
        ...
        self.max_particles_in_jet = config.get(
            "max_particles_in_jet",
            128
        )
        ...
        self.train_fraction = config.get(
            "train_fraction",
            0.8
        )

        self.val_fraction = config.get(
            "val_fraction",
            0.1
        )
    ...
    def setup(self, stage=None):
        ...
        files = glob.glob(
            os.path.join(self.data_dir, "*.root")
        )
        ...
        n_train = int(
            self.train_fraction * n_total
        )

        n_val = int(
            self.val_fraction * n_total
        )
